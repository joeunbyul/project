...
public class MypageItemPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_modifypage);
        //intent로 받아온내용
        ...
        item_userid = item.getExtras().getString("item_userid");
        ...
        supportMapFragment.getMapAsync(MypageItemPage.this);
    ...
    public void onMapReady(GoogleMap googleMap){
        ...
        if (list != null) {
            if (list.size() == 0) {
                ...
                String str = String.format("geo : %f, %f",lat,log);
