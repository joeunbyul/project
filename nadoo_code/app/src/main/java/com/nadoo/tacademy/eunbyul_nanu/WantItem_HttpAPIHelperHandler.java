...
public class WantItem_HttpAPIHelperHandler {
    private static final String DEBUG_TAG = "WantItem_HttpAPIHelperHandler";

    public static ArrayList<WantItemObject> wantItemAllSelect() {
        ...
        try {
            ...
            Request request = new Request
                    .Builder()
                    .url(NetworkDefineConstant.SERVER_URL_NADO_WANTITEM_LIST+"?page="+pageCount)
                    .build();
